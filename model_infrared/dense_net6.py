...
history = model.fit(x_train, y_train, epochs=30, batch_size=32, validation_data=(x_test, y_test), callbacks=[early_stopping])  # EarlyStopping 추가
end_time = time.time()
...
plt.legend()
# 파일로 저장
output_path = os.path.join("./", f'learning_curve6.png')
